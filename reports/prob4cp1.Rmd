...
number2 <- ggplot(essa_aqui, aes(file_extension, media_usuarios, fill = file_extension)) + 
  labs(x = "Linguagem",
       y = "Média de usuário que commitaram",
       title = "Média de popularidade do Python vs Shell em Finais de Semana" ) +
  geom_bar(stat="identity", position = "dodge") + 
  scale_fill_brewer(palette = "Set1")
...
Podemos ver a gritante diferença de popularidade entre *shell* e *python* durante os commits de finais de semana. O pessoal prefere passar o free time se divertindo com *python*, claramente. 